        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/news" className="text-gray-300 hover:text-green-400 transition-colors">Cricket News</a></li>
              <li><a href="/live-scoring" className="text-gray-300 hover:text-green-400 transition-colors">Live Scoring</a></li>
