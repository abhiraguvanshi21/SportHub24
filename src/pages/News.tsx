...
const News = () => {
  ...
  const convertExternalArticle = useCallback((externalArticle: ExternalNewsArticle): NewsArticle => {
    ...
    return {
      ...
      tags: externalArticle.tags || [externalArticle.source.name, 'Cricket', '2025'],
      isBreaking: category === 'breaking' || hoursAgo < 2,
      isFeatured: Math.random() > 0.7,
      isLive: category === 'live-update',
      source: externalArticle.source.name,
      readTime: externalArticle.readTime || Math.ceil(externalArticle.content.length / 200),
  ...
  useEffect(() => {
    ...
    const handleAutoUpdate = (data: { articles: ExternalNewsArticle[]; liveUpdates: LiveNewsUpdate[]; trending: TrendingTopic[] }) => {
      ...
      setLastUpdateTime(new Date());
      setNextUpdateIn(600); // Reset countdown
      console.log('🔄 Auto-updated news data');
    };

    newsService.addUpdateListener(handleAutoUpdate);
  ...
  useEffect(() => {
    const handleOnline = () => {
      setIsOnline(true);
      setError(null);
      if (isLiveMode && autoUpdateEnabled) {
        fetchRealNews();
      }
    };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-red-100 max-w-3xl mx-auto mb-8">
              Real-time cricket news from ESPN Cricinfo, Cricbuzz, and other trusted sources with high-quality images
            </p>
            <div className="flex items-center justify-center space-x-6 text-red-100">
              ...
              {autoUpdateEnabled && isOnline && (
                <div className="flex items-center">
                  ...
                  <span>Next update: {formatCountdown(nextUpdateIn)}</span>
                </div>
              )}
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            ...
            {isLoading && articles.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600">Fetching latest cricket news with high-quality images...</p>
              </div>
            )}
            ...
            {filteredArticles.filter(article => article.isFeatured).length > 0 && (
              <div className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                  ...
                  Featured Stories with High-Quality Images
                </h2>
                      ...
                      <div className="relative">
                        <img 
                          ...
                          onError={(e) => {
                            ...
                            target.src = 'https://images.unsplash.com/photo-1540747913346-19e32dc3e97e?w=800&h=400&fit=crop';
                          }}
                        />
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                ...
                Latest Cricket News with Auto-Update
                {isLiveMode && isOnline && (
                ...
                {autoUpdateEnabled && isOnline && (
                  <div className="ml-3 flex items-center text-green-600">
                    ...
                    <span className="text-sm font-medium">Auto-refresh: {formatCountdown(nextUpdateIn)}</span>
                  </div>
                )}
              </h2>
          ...
          <div className="space-y-6">
            ...
            <div className={`rounded-xl shadow-lg p-6 border ${
              autoUpdateEnabled && isOnline ? 'bg-green-50 border-green-200' : 'bg-gray-50 border-gray-200'
            }`}>
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-lg font-bold text-gray-900">Auto-Update Status</h3>
                {autoUpdateEnabled && isOnline ? (
              ...
              <button
                onClick={() => setAutoUpdateEnabled(!autoUpdateEnabled)}
                className={`mt-2 w-full py-2 px-4 rounded-lg font-medium transition-colors ${
                  autoUpdateEnabled 
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 border border-red-100">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">Next Auto-Update</span>
                  <span className="font-bold text-green-600">
                    {autoUpdateEnabled && isOnline ? formatCountdown(nextUpdateIn) : 'Disabled'}
                  </span>
                </div>
              </div>
            </div>
