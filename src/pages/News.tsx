...
const News = () => {
  ...
  const featuredStories = [
    ...
    {
      title: 'Afghanistan’s historic semi-final dream alive',
      image: 'https://thvnext.bing.com/th/id/OIP.6CHbMxxTbTA3kCMJG_rFqwHaEK?w=278&h=180&c=7&r=0&o=7&cb=thvnext&dpr=1.3&pid=1.7&rm=3',
      description: 'Afghanistan’s unbeaten run continues in the T20 World Cup, surprising all with fearless cricket.',
    }
  ];
